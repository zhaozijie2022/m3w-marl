...
class WorldModelCritic:
	def __init__(self, args, share_obs_space, act_space,
		num_agents, state_type, device=torch.device("cpu"), wm_args=None,):
	...
	def get_values(self, share_obs, actions, mode='mean'):
